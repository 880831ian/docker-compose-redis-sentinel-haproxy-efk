...
echo "elasticsearch IPAddress:"
elasticsearch_ip=`docker inspect elasticsearch | grep "IPv4" | egrep -o "[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}"`
echo $elasticsearch_ip;
echo "------------------------------"
echo "kibana IPAddress:"
kibana_ip=`docker inspect kibana | grep "IPv4" | egrep -o "[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}"`
echo $kibana_ip;
echo "------------------------------"
echo "fluentd IPAddress:"
fluentd_ip=`docker inspect fluentd | grep "IPv4" | egrep -o "[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}"`
echo $fluentd_ip;
echo "------------------------------"
